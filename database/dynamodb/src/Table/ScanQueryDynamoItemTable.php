...
class ScanQueryDynamoItemTable extends Table
{
    const ONE_BYTE = 1;
    ...
    public function addDynamoItem(array $item) {
        ...
        $countEventualRead       = $countBytes / self::ONE_RCU_ON_EVENTUAL_READ;
        $countConsistentRead     = $countBytes / self::ONE_RCU_ON_CONSISTENT_READ;
        $countTransactionalRead  = $countBytes / self::ONE_RCU_ON_TRANSACTIONAL_READ;
    ...
    public function render()
    {
        ...
        $countConsistentRead     = ceil($this->countBytes / self::ONE_RCU_ON_CONSISTENT_READ);
